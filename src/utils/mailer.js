...
let transporter;
const LOGO_CID = "origenes-fleet-logo";
  ...
  return `
    ...
    <html lang="es">
      ...
      <body style="margin: 0; padding: 0; background-color: #f4f6f8; font-family: Arial, Helvetica, sans-serif; color: #1f2937;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; margin: 0; padding: 0; background-color: #f4f6f8;">
          <tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; max-width: 520px; margin: 0 auto;">
                <tr>
                  <td align="center" style="padding: 0 0 18px;">
                    <img src="cid:${LOGO_CID}" width="54" height="54" alt="Origenes Fleet" style="display: block; width: 54px; height: 54px; border: 0; outline: none; text-decoration: none; border-radius: 14px;" />
                  </td>
                </tr>
                <tr>
                  <td style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 14px; padding: 34px 28px; box-shadow: 0 12px 28px rgba(15, 43, 70, 0.08);">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td align="center" style="padding: 0;">
                          <h1 style="margin: 0; color: #1f2937; font-size: 24px; line-height: 1.25; font-weight: 700;">
                            Verificacion de correo
                          </h1>
                          <p style="margin: 14px 0 0; color: #6b7280; font-size: 15px; line-height: 1.6;">
                            Usa este codigo para verificar tu cuenta y activar tu correo en Origenes Fleet.
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td align="center" style="padding: 28px 0 24px;">
                          <div style="display: inline-block; min-width: 188px; padding: 18px 26px; border-radius: 12px; border: 1px solid #e5e7eb; background-color: #f9fafb; color: #0f2b46; font-size: 36px; line-height: 1; font-weight: 700; letter-spacing: 10px; text-align: center;">
                            ${code}
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td align="center" style="padding: 0;">
                          <p style="margin: 0; color: #1f2937; font-size: 14px; line-height: 1.6;">
                            Este codigo expira en <strong style="color: #1f7ae0;">30 minutos</strong>.
                          </p>
...
function buildComplianceAlertEmailHtml(alert) {
  const statusColor = alert.status === "Vencido" ? "#dc2626" : "#1f7ae0";
  ...
  const imageMarkup = alert.hasPhoto
    ...
    : `<div style="height: 150px; border-radius: 12px; background-color: #f9fafb; border: 1px solid #e5e7eb; color: #6b7280; font-size: 14px; line-height: 150px; text-align: center;">Sin foto registrada</div>`;
          ...
          <tr>
            <td align="center" style="padding: 32px 16px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; max-width: 560px; margin: 0 auto;">
                ...
                <tr>
                  <td style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 14px; padding: 28px; box-shadow: 0 12px 28px rgba(15, 43, 70, 0.08);">
                    ${imageMarkup}
                    <h1 style="margin: 24px 0 0; color: #1f2937; font-size: 24px; line-height: 1.25; font-weight: 700;">
                      ${title}
                    </h1>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin: 24px 0 0; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #f9fafb;">
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 16px 18px;">
                          ...
                          <strong style="display: inline-block; margin-top: 8px; padding: 7px 10px; border-radius: 999px; color: ${statusColor}; background-color: ${alert.status === "Vencido" ? "rgba(220, 38, 38, 0.10)" : "rgba(31, 122, 224, 0.10)"}; font-size: 13px;">
                            ${status}
                          </strong>
                        </td>
                      </tr>
...
function buildBaseAttachments() {
  return [
    {
      filename: "iconbgblanco.png",
      path: path.join(process.cwd(), "public", "media", "iconbgblanco.png"),
      cid: LOGO_CID,
    },
  ];
}
...
async function sendVerificationCode(to, code) {
  ...
  await mailer.sendMail({
    from: `"Origenes Fleet" <${fromAddress}>`,
    to,
    subject: "Codigo de verificacion - Origenes Fleet",
